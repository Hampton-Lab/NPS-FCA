...
png(filename = "corrplot_physio.png", width = 6, height = 6, units = "in",res=300)
...
png(filename = "corrplot2011y.png", width = 6, height = 6, units = "in",res=300)
...
dev.off()
png(filename = "corrplot2015y.png", width = 6, height = 6, units = "in",res=300)
...
write.csv(stats_temper_out,"temper_out.csv",row.names=FALSE)
write.csv(stats_nontemper_out,"nontemp_out.csv",row.names=FALSE)
write.csv(longstats_out,"longstats.csv",row.names=FALSE)
write.csv(widestats_out,"widestats.csv",row.names=FALSE)
