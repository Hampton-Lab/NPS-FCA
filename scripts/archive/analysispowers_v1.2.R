...
temper_interact1<-rbind(m_yrdepth,m_yrvol,m_yrwa,m_yrelev,m_yrwala,m_yrasp,m_swe,m_flush)
...
#merge(temper_interact,temper_interact2,by=c("variable","model"),all=TRUE)
#subset(temper_interact2,temper_interact2)
...
#merge(temper_interact,temper_interact2,by=c("variable","model"),all=TRUE)#,suffixes=c(".main",".interact"))
