...
#temperature model
vars_1covar<-combn(c("ice_out_doy","SWE_May_snotel"),1)#,"solar_jas","solar_dec","Volume_m3","hydro"),1)
vars_2covar<-combn(c("ice_out_doy","SWE_May_snotel"),2)#,"solar_jas","solar_dec","Volume_m3","hydro"),2)
vars_3covar<-combn(c("ice_out_doy","SWE_May_snotel","hydro"),3)#,"solar_jas","solar_dec","Volume_m3","hydro"),3)
...
#secchi models
vars_1covar<-combn(c("ice_out_doy","SWE_May_snotel","Chl"),1)#,"hydro"),1)
vars_2covar<-combn(c("ice_out_doy","SWE_May_snotel","Chl"),2)#,"hydro"),2)
vars_3covar<-combn(c("ice_out_doy","SWE_May_snotel","Chl"),3)#,"hydro"),3)
...
#chlorophyll models
vars_1covar<-combn(c("ice_out_doy","SWE_May_snotel","TDN","TDP","Watertemp"),1)#,"solar_jas","solar_dec","Watertemp"),1)
vars_2covar<-combn(c("ice_out_doy","SWE_May_snotel","TDN","TDP","Watertemp"),2)#"solar_jas","solar_dec","Watertemp"),2)
vars_3covar<-combn(c("ice_out_doy","SWE_May_snotel","TDN","TDP","Watertemp"),3)#"solar_jas","solar_dec","Watertemp"),3)
...
# Conductivity models
vars_1covar<-combn(c("ice_out_doy","SWE_May_snotel"),1)#,"hydro","Volume_m3","Chl"),1)
vars_2covar<-combn(c("ice_out_doy","SWE_May_snotel"),2)#,"hydro","Volume_m3","Chl"),2)
vars_3covar<-combn(c("ice_out_doy","SWE_May_snotel","hydro"),3)#,"hydro","Volume_m3","Chl"),3)
...
#N models
vars_1covar<-combn(c("ice_out_doy","SWE_May_snotel","Watertemp"),1)#forest","N_dep_2000_2009","NH4_dep_2000_2009","NO3_dep_2000_2009","Watertemp"),1)
vars_2covar<-combn(c("ice_out_doy","SWE_May_snotel","Watertemp"),2)#"forest","N_dep_2000_2009","NH4_dep_2000_2009","NO3_dep_2000_2009","Watertemp"),2)
vars_3covar<-combn(c("ice_out_doy","SWE_May_snotel","Watertemp"),3)#"forest","N_dep_2000_2009","NH4_dep_2000_2009","NO3_dep_2000_2009","Watertemp"),3)
...
#P models
vars_1covar<-combn(c("ice_out_doy","SWE_May_snotel"),1)#,"forest","hydro","Depth_mean_m"),1)
vars_2covar<-combn(c("ice_out_doy","SWE_May_snotel"),2)#,"forest","hydro","Depth_mean_m"),2)
vars_3covar<-combn(c("ice_out_doy","SWE_May_snotel","hydro"),3)#,"forest","hydro","Depth_mean_m"),3)
...
#SO4 models
vars_1covar<-combn(c("ice_out_doy","SWE_May_snotel","TDN","Watertemp"),1)#,"SO4_dep_2000_2009","hydro","TDN","Watertemp"),1)
vars_2covar<-combn(c("ice_out_doy","SWE_May_snotel","TDN","Watertemp"),2)#,"SO4_dep_2000_2009","hydro","TDN","Watertemp"),2)
vars_3covar<-combn(c("ice_out_doy","SWE_May_snotel","TDN","Watertemp"),3)#,"SO4_dep_2000_2009","hydro","TDN","Watertemp"),3)
...
#Cl models
vars_1covar<-combn(c("ice_out_doy","SWE_May_snotel"),1)#,"Cl_dep_2000_2009","hydro"),1)
vars_2covar<-combn(c("ice_out_doy","SWE_May_snotel"),2)#,"Cl_dep_2000_2009","hydro"),2)
vars_3covar<-combn(c("ice_out_doy","SWE_May_snotel","hydro"),3)#,"Cl_dep_2000_2009","hydro"),3)
