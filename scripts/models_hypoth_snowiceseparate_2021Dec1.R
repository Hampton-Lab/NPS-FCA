...
which_exclude<-which(vars_2covar[1,]=="ice_out_doy" & vars_2covar[2,]=="SWE_May_snotel")
vars_2covar<-vars_2covar[,-which_exclude]
which_exclude<-which(vars_3covar[1,]=="ice_out_doy" & vars_3covar[2,]=="SWE_May_snotel")
vars_3covar<-vars_3covar[,-which_exclude]
...
#models_top_df<-models_df %>% filter(AICcdiff<=3.99) %>% arrange(varname,AICcdiff)
#models_top_df<-models_df %>% filter(AICcdiff<=5.99) %>% arrange(varname,AICcdiff)
#models_top_df<-models_df %>% filter(AICcdiff<=7.99) %>% arrange(varname,AICcdiff)
