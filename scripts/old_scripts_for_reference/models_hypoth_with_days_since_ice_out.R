...
#SWE model
vars_1covar<-combn(c("ice_out_doy","days_since_iceout","solar_jas","solar_dec"),1)
vars_2covar<-combn(c("ice_out_doy","days_since_iceout","solar_jas","solar_dec"),2)
vars_3covar<-combn(c("ice_out_doy","days_since_iceout","solar_jas","solar_dec"),3)
...
#temperature model
vars_1covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","solar_jas","solar_dec","Volume_m3","hydro"),1)
vars_2covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","solar_jas","solar_dec","Volume_m3","hydro"),2)
vars_3covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","solar_jas","solar_dec","Volume_m3","hydro"),3)
vars_2covar<-vars_2covar[,-1]
vars_3covar<-vars_3covar[,-c(1,2,3,4,5)]
...
data_formodel_multi<- data_forstats %>% filter(var_abbrev1 %in% c("Chl","Secchi","TDN","TDP","Watertemp","SO4","DO","pH","Cond")) %>% 
  select(var_abbrev1,park_site,park_code,year,snowyr,
         ...
         solar_jas,solar_dec,forest,hydro,Depth_mean_m,Volume_m3,ice_out_doy,days_since_iceout,
...
#secchi models
vars_1covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","Chl","hydro"),1)
vars_2covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","Chl","hydro"),2)
vars_3covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","Chl","hydro"),3)
...
#chlorophyll models
vars_1covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","TDN","TDP","solar_jas","solar_dec","Watertemp"),1)
vars_2covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","TDN","TDP","solar_jas","solar_dec","Watertemp"),2)
vars_3covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","TDN","TDP","solar_jas","solar_dec","Watertemp"),3)
...
#oxygen models
vars_1covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","Watertemp","Chl"),1)
vars_2covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","Watertemp","Chl"),2)
vars_3covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","Watertemp","Chl"),3)
...
# Conductivity models
vars_1covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","hydro","Volume_m3","Chl"),1)
vars_2covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","hydro","Volume_m3","Chl"),2)
vars_3covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","hydro","Volume_m3","Chl"),3)
...
#N models
vars_1covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","forest","N_dep_2000_2009","NH4_dep_2000_2009","NO3_dep_2000_2009","Watertemp"),1)
vars_2covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","forest","N_dep_2000_2009","NH4_dep_2000_2009","NO3_dep_2000_2009","Watertemp"),2)
vars_3covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","forest","N_dep_2000_2009","NH4_dep_2000_2009","NO3_dep_2000_2009","Watertemp"),3)
...
#P models
vars_1covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","forest","hydro","Depth_mean_m"),1)
vars_2covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","forest","hydro","Depth_mean_m"),2)
vars_3covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","forest","hydro","Depth_mean_m"),3)
...
#SO4 models
vars_1covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","SO4_dep_2000_2009","hydro","TDN","Watertemp"),1)
vars_2covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","SO4_dep_2000_2009","hydro","TDN","Watertemp"),2)
vars_3covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","SO4_dep_2000_2009","hydro","TDN","Watertemp"),3)
...
#Cl models
vars_1covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","Cl_dep_2000_2009","hydro"),1)
vars_2covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","Cl_dep_2000_2009","hydro"),2)
vars_3covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","Cl_dep_2000_2009","hydro"),3)
...
for (i in 1:length(geolvars)){
  geolvari<-geolvars[i]
  combparti<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","hydro","Volume_m3",geolvari),2)
...
for (i in 1:length(geolvars)){
  geolvari<-geolvars[i]
  combparti<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","hydro","Volume_m3",geolvari),3)
  combparti<-combparti[,-c(2,4)]
  if(i==1){vars_3covar0<-combparti}
  if(i>1){vars_3covar0<-cbind(vars_3covar0,combparti)}
}

vars_1covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","hydro","Volume_m3",geolvari),1)
...
#zoop models
vars_1covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","Watertemp","Chl","Ca"),1)
vars_2covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","Watertemp","Chl","Ca"),2)
vars_3covar<-combn(c("ice_out_doy","days_since_iceout","SWE_May_snotel","Watertemp","Chl","Ca"),3)
