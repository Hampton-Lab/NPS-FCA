...
#    mi$term[grep("vari1:vari2",mi$term)]<-paste(var1i,":",var2i,sep="")
#    mi$term[grep("vari2:vari1",mi$term)]<-paste(var2i,":",var1i,sep="")   
    if(i==1){m_2covar<-mi}
...
m_2covar_temp<-m_2covar0 %>% arrange(AICc)
