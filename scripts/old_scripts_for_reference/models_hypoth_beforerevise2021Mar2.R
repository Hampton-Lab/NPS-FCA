...
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="SWE",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=1)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="SWE",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="SWE",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=1)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="SWE",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="SWE",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3b,
                     randompart=randompart,doplots=doplots_set)

m_covar_SWE<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_SWE<-m_covar_SWE %>% mutate_if(is.numeric, signif,digits=4)
...
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="ice_out_doy",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="ice_out_doy",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="ice_out_doy",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="ice_out_doy",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3,
                      randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="ice_out_doy",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3b,
                     randompart=randompart,doplots=doplots_set)
m_covar_ice_out<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_ice_out<-m_covar_ice_out %>% mutate_if(is.numeric, signif,digits=4)
...
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="Watertemp",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Watertemp",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Watertemp",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2b,
                     randompart=randompart,doplots=1)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Watertemp",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3,
                      randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Watertemp",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3b,
                     randompart=randompart,doplots=1)
m_covar_temp<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_temp<-m_covar_temp %>% mutate_if(is.numeric, signif,digits=4)
...
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="Secchi",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Secchi",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2,
                      randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Secchi",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Secchi",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Secchi",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=1)
m_covar_secchi<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_secchi<-m_covar_secchi %>% mutate_if(is.numeric, signif,digits=4)
...
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="Chl",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Chl",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Chl",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Chl",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Chl",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_chl<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_chl<-m_covar_chl %>% mutate_if(is.numeric, signif,digits=4)
...
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="log10Chl",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="log10Chl",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="log10Chl",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="log10Chl",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="log10Chl",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_chllog10<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_chllog10<-m_covar_chllog10 %>% mutate_if(is.numeric, signif,digits=4)
...
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="DO",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="DO",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="DO",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="DO",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="DO",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_do<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_do<-m_covar_do %>% mutate_if(is.numeric, signif,digits=4)
...
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="Cond",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Cond",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Cond",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Cond",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Cond",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_Cond<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_Cond<-m_covar_Cond %>% mutate_if(is.numeric, signif,digits=4)
...
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="TDN",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="TDN",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="TDN",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="TDN",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="TDN",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_N<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_N<-m_covar_N %>% mutate_if(is.numeric, signif,digits=4)
...
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="TDP",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="TDP",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="TDP",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="TDP",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="TDP",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_P<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_P<-m_covar_P %>% mutate_if(is.numeric, signif,digits=4)
...
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="SO4",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="SO4",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="SO4",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="SO4",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="SO4",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_SO4<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_SO4<-m_covar_SO4 %>% mutate_if(is.numeric, signif,digits=4)
...
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="Cl",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Cl",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Cl",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Cl",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Cl",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_Cl<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_Cl<-m_covar_Cl %>% mutate_if(is.numeric, signif,digits=4)
...
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="pH",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="pH",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="pH",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="pH",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="pH",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)

m_covar_pH<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_pH<-m_covar_pH %>% mutate_if(is.numeric, signif,digits=4)

#ions models
data_formodel<- data_forstats %>% filter(var_abbrev1=="Ca") 
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="Ca",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Ca",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Ca",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Ca",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Ca",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_Ca<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_Ca<-m_covar_Ca %>% mutate_if(is.numeric, signif,digits=4)

data_formodel<- data_forstats %>% filter(var_abbrev1=="Mg") 
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="Mg",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Mg",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Mg",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Mg",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Mg",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_Mg<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_Mg<-m_covar_Mg %>% mutate_if(is.numeric, signif,digits=4)

data_formodel<- data_forstats %>% filter(var_abbrev1=="K") 
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="K",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="K",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="K",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="K",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="K",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_K<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_K<-m_covar_K %>% mutate_if(is.numeric, signif,digits=4)

data_formodel<- data_forstats %>% filter(var_abbrev1=="Na") 
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="Na",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Na",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Na",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Na",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Na",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_Na<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_Na<-m_covar_Na %>% mutate_if(is.numeric, signif,digits=4)
...
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="Clad",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Clad",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Clad",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Clad",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Clad",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_CLAD<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_CLAD<-m_covar_CLAD %>% mutate_if(is.numeric, signif,digits=4)


data_formodel$value<-data_formodel$rot
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="Rot",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Rot",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Rot",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Rot",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Rot",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_ROT<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_ROT<-m_covar_ROT %>% mutate_if(is.numeric, signif,digits=4)

data_formodel$value<-data_formodel$cope
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="Cope",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Cope",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="Cope",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Cope",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="Cope",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_COPE<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_COPE<-m_covar_COPE %>% mutate_if(is.numeric, signif,digits=4)


# now log10 trans

data_formodel$value<-log10(data_formodel$clad+min(data_formodel$clad[which(data_formodel$clad>0)],na.rm=TRUE))
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="log10Clad",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="log10Clad",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="log10Clad",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="log10Clad",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="log10Clad",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_CLADlog10<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_CLADlog10<-m_covar_CLADlog10 %>% mutate_if(is.numeric, signif,digits=4)


data_formodel$value<-log10(data_formodel$rot+min(data_formodel$rot[which(data_formodel$rot>0)],na.rm=TRUE))
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="log10Rot",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="log10Rot",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="log10Rot",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="log10Rot",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="log10Rot",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_ROTlog10<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_ROTlog10<-m_covar_ROTlog10 %>% mutate_if(is.numeric, signif,digits=4)

data_formodel$value<-log10(data_formodel$cope+min(data_formodel$cope[which(data_formodel$cope>0)],na.rm=TRUE))
m_1covar0<-mod_covar(covars=vars_1covar,data=data_formodel,varname="log10Cope",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart1,
                     randompart=randompart,doplots=doplots_set)
m_2covar0<-mod_covar(covars=vars_2covar,data=data_formodel,varname="log10Cope",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart2,
                     randompart=randompart,doplots=doplots_set)
m_2covar0b<-mod_covar(covars=vars_2covar,data=data_formodel,varname="log10Cope",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart2b,
                      randompart=randompart,doplots=doplots_set)
m_3covar0<-mod_covar(covars=vars_3covar,data=data_formodel,varname="log10Cope",
                     valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                     fixedpart=fixedpart3,
                     randompart=randompart,doplots=doplots_set)
m_3covar0b<-mod_covar(covars=vars_3covar,data=data_formodel,varname="log10Cope",
                      valuecol=valuecol_set,swecol=swecol_set,iceoutdcol=iceoutdcol_set,
                      fixedpart=fixedpart3b,
                      randompart=randompart,doplots=doplots_set)
m_covar_COPElog10<-rbind(m_1covar0,m_2covar0,m_2covar0b,m_3covar0,m_3covar0b)  %>% arrange(AICc)
m_covar_COPElog10<-m_covar_COPElog10 %>% mutate_if(is.numeric, signif,digits=4)
