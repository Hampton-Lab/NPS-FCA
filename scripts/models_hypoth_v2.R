...
models_df_checks$hasiceoutd<-grepl("ice_out_doy",models_df_checks$modelformula) %>% as.numeric()
models_df_checks$hasSWE<-0
models_df_checks$hasSWE<-grepl("SWE_May_snotel",models_df_checks$modelformula) %>% as.numeric()
