...
#SWE model
vars_1covar<-combn(c("ice_out_doy","lon","solar_jas","solar_dec"),1)
vars_2covar<-combn(c("ice_out_doy","lon","solar_jas","solar_dec"),2)
vars_3covar<-combn(c("ice_out_doy","lon","solar_jas","solar_dec"),3)
...
#ice_out_doy model
vars_1covar<-combn(c("SWE_May_snotel","solar_jas","solar_dec","Volume_m3","Elevation_m","lon"),1)
vars_2covar<-combn(c("SWE_May_snotel","solar_jas","solar_dec","Volume_m3","Elevation_m","lon"),2)
vars_3covar<-combn(c("SWE_May_snotel","solar_jas","solar_dec","Volume_m3","Elevation_m","lon"),3)
data_formodel<- data_forstats
...
#temperature model
vars_1covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","solar_jas","solar_dec","Volume_m3","hydro"),1)
vars_2covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","solar_jas","solar_dec","Volume_m3","hydro"),2)
vars_3covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","solar_jas","solar_dec","Volume_m3","hydro"),3)
...
#secchi models
vars_1covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","Chl","hydro"),1)
vars_2covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","Chl","hydro"),2)
vars_3covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","Chl","hydro"),3)
...
#chlorophyll models
vars_1covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","TDN","TDP","solar_jas","solar_dec","Watertemp"),1)
vars_2covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","TDN","TDP","solar_jas","solar_dec","Watertemp"),2)
vars_3covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","TDN","TDP","solar_jas","solar_dec","Watertemp"),3)
...
#oxygen models
vars_1covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","Watertemp","Chl"),1)
vars_2covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","Watertemp","Chl"),2)
vars_3covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","Watertemp","Chl"),3)
...
# Conductivity models
vars_1covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","hydro","Volume_m3","Chl"),1)
vars_2covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","hydro","Volume_m3","Chl"),2)
vars_3covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","hydro","Volume_m3","Chl"),3)
...
#N models
vars_1covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","forest","N_dep_2000_2009","NH4_dep_2000_2009","NO3_dep_2000_2009","Watertemp"),1)
vars_2covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","forest","N_dep_2000_2009","NH4_dep_2000_2009","NO3_dep_2000_2009","Watertemp"),2)
vars_3covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","forest","N_dep_2000_2009","NH4_dep_2000_2009","NO3_dep_2000_2009","Watertemp"),3)
...
#P models
vars_1covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","forest","hydro","Depth_mean_m"),1)
vars_2covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","forest","hydro","Depth_mean_m"),2)
vars_3covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","forest","hydro","Depth_mean_m"),3)
...
#SO4 models
vars_1covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","SO4_dep_2000_2009","hydro","TDN","Watertemp"),1)
vars_2covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","SO4_dep_2000_2009","hydro","TDN","Watertemp"),2)
vars_3covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","SO4_dep_2000_2009","hydro","TDN","Watertemp"),3)
...
#Cl models
vars_1covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","Cl_dep_2000_2009","hydro"),1)
vars_2covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","Cl_dep_2000_2009","hydro"),2)
vars_3covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","Cl_dep_2000_2009","hydro"),3)
...
#zoop models
vars_1covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","Watertemp","Chl","Ca"),1)
vars_2covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","Watertemp","Chl","Ca"),2)
vars_3covar<-combn(c("ice_out_doy","lon","SWE_May_snotel","Watertemp","Chl","Ca"),3)
