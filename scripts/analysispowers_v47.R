...
#  geom_line(aes(x=a,y=preds,group=park_site))+
  geom_smooth(aes(x=a,y=preds),se=FALSE,color="dark gray")+
...
tdnplot<-ggplot(plotdata, aes(x = a, y = value)) + 
  geom_point(size = ptsize,aes(x = a, y = value, color=park_site)) + # change size and colour
  geom_line(aes(x=a,y=preds),se=FALSE,color="dark gray")+#,group=park_site))+
  scale_color_viridis_d(end = 0.85,na.value="dark gray")+
  theme_bw()+
  theme(legend.position="none",
        panel.grid.major = element_blank(), panel.grid.minor = element_blank())
...
cladplot<-ggplot(plotdata, aes(x = a, y = value)) + 
  geom_point(size = ptsize,aes(x = a, y = value, color = park_code)) + # change size and colour
#  geom_line(aes(x=a,y=preds,group=park_site))+
  geom_smooth(aes(x=a,y=preds),se=FALSE,color="dark gray")+#,group=park_site))+
  scale_color_viridis_d(end = 0.85,na.value="dark gray")+
  theme_bw()+
  theme(legend.position="none",
        panel.grid.major = element_blank(), panel.grid.minor = element_blank())
...
gridplot<-grid.arrange(wtempplot,secchiplot,phplot,chlplot,tdnplot,cladplot)
gridplot
